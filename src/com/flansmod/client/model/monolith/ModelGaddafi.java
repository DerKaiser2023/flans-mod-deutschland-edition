...
public class ModelGaddafi extends ModelCustomArmour
{
    ...
    private void initleftArmModel_1() {
        (this.leftArmModel[0] = new ModelRendererTurbo((ModelBase)this, 81, 17, this.textureX, this.textureY)).addShapeBox(-1.0f, -2.0f, -2.0f, 4, 11, 4, 0.0f, 0.0f, 0.5f, 0.0f, 0.1f, 0.1f, 0.0f, 0.1f, 0.1f, 0.0f, 0.0f, 0.5f, 0.0f, 0.2f, 0.5f, 0.5f, 1.0f, 0.0f, 0.5f, 1.0f, 0.0f, 0.5f, 0.2f, 0.5f, 0.5f);
        this.leftArmModel[0].func_78793_a(0.0f, 0.0f, 0.0f);
    }
    
    private void initrightArmModel_1() {
        (this.rightArmModel[0] = new ModelRendererTurbo((ModelBase)this, 105, 17, this.textureX, this.textureY)).addShapeBox(-3.0f, -2.0f, -2.0f, 4, 11, 4, 0.0f, 0.1f, 0.1f, 0.0f, 0.0f, 0.5f, 0.0f, 0.0f, 0.5f, 0.0f, 0.1f, 0.1f, 0.0f, 1.0f, 0.0f, 0.5f, 0.2f, 0.5f, 0.5f, 0.2f, 0.5f, 0.5f, 1.0f, 0.0f, 0.5f);
