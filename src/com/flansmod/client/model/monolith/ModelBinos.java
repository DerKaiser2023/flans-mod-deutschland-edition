...
public class ModelBinos extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].func_78793_a(-3.5f, -3.0f, 0.1f);
        ...
        this.gunModel[1].func_78793_a(-3.5f, -3.5f, 0.1f);
        ...
        this.gunModel[2].func_78793_a(-3.5f, -2.5f, 0.1f);
        ...
        this.gunModel[3].func_78793_a(-2.0f, -3.0f, -1.7f);
        ...
        this.gunModel[4].func_78793_a(-2.0f, -4.0f, -1.7f);
        ...
        this.gunModel[5].func_78793_a(-2.0f, -2.0f, -1.7f);
        ...
        this.gunModel[6].func_78793_a(1.0f, -3.1f, -1.9f);
        ...
        this.gunModel[7].func_78793_a(1.0f, -3.7f, -1.9f);
        ...
        this.gunModel[8].func_78793_a(1.0f, -2.5f, -1.9f);
        ...
        this.gunModel[9].func_78793_a(-2.0f, -3.0f, 2.8f);
        ...
        this.gunModel[10].func_78793_a(-2.0f, -4.0f, 2.8f);
        ...
        this.gunModel[11].func_78793_a(-2.0f, -2.0f, 2.8f);
        ...
        this.gunModel[12].func_78793_a(-2.0f, -4.2f, 1.5f);
        ...
        this.gunModel[13].func_78793_a(-2.0f, -4.4f, 1.5f);
        ...
        this.gunModel[14].func_78793_a(-2.0f, -4.0f, 1.5f);
        ...
        this.gunModel[15].func_78793_a(0.2f, -4.2f, 1.5f);
        ...
        this.gunModel[16].func_78793_a(0.2f, -4.2f, 1.5f);
        ...
        this.gunModel[17].func_78793_a(-2.2f, -4.2f, 1.5f);
        ...
        this.gunModel[18].func_78793_a(-2.2f, -4.2f, 1.5f);
        ...
        this.gunModel[19].func_78793_a(1.0f, -3.7f, 4.0f);
        ...
        this.gunModel[20].func_78793_a(1.0f, -3.1f, 4.0f);
        ...
        this.gunModel[21].func_78793_a(1.0f, -2.5f, 4.0f);
        ...
        this.gunModel[22].func_78793_a(-4.5f, -3.5f, 0.1f);
        ...
        this.gunModel[23].func_78793_a(-4.5f, -3.0f, 0.1f);
        ...
        this.gunModel[24].func_78793_a(-4.5f, -2.5f, 0.1f);
        ...
        this.gunModel[25].func_78793_a(-4.5f, -3.5f, 3.0f);
        ...
        this.gunModel[26].func_78793_a(-3.5f, -3.5f, 3.0f);
        ...
        this.gunModel[27].func_78793_a(-3.5f, -3.0f, 3.0f);
        ...
        this.gunModel[28].func_78793_a(-3.5f, -2.5f, 3.0f);
        ...
        this.gunModel[29].func_78793_a(-4.5f, -2.5f, 3.0f);
        ...
        this.gunModel[30].func_78793_a(-4.5f, -3.0f, 3.0f);
    }
}
