...
public class ModelNinja extends ModelCustomArmour
{
    ...
    public ModelNinja() {
        this.textureX = 512;
        this.textureY = 512;
        (this.headModel = new ModelRendererTurbo[10])[0] = new ModelRendererTurbo((ModelBase)this, 441, 9, this.textureX, this.textureY);
        ...
        (this.leftArmModel[0] = new ModelRendererTurbo((ModelBase)this, 1, 17, this.textureX, this.textureY)).addShapeBox(-1.0f, -2.0f, -2.0f, 4, 11, 4, 0.0f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.6f, 0.0f, 0.6f, 0.6f, 0.0f, 0.6f, 0.6f, 0.0f, 0.6f, 0.6f, 0.0f, 0.6f);
        this.leftArmModel[0].func_78793_a(0.0f, 0.0f, 0.0f);
        this.rightArmModel = new ModelRendererTurbo[1];
        (this.rightArmModel[0] = new ModelRendererTurbo((ModelBase)this, 137, 1, this.textureX, this.textureY)).addShapeBox(-3.0f, -2.0f, -2.0f, 4, 11, 4, 0.0f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.2f, 0.6f, 0.0f, 0.6f, 0.6f, 0.0f, 0.6f, 0.6f, 0.0f, 0.6f, 0.6f, 0.0f, 0.6f);
