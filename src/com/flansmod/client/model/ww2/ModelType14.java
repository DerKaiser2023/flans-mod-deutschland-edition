...
public class ModelType14 extends ModelGun
{
    ...
    public ModelType14() {
        ...
        (this.ammoModel[0] = new ModelRendererTurbo(this, 0, 306, this.textureX, this.textureY)).func_78790_a(0.2f, 0.5f, -0.5f, 1, 4, 1, 0.0f);
        ...
        (this.slideModel[0] = new ModelRendererTurbo(this, 0, 295, this.textureX, this.textureY)).func_78790_a(0.0f, 0.0f, 0.0f, 2, 1, 1, 0.0f);
