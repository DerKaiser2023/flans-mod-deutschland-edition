...
public class ModelSpitfire extends ModelPlane
{
    public ModelSpitfire() {
        ...
        (this.bodyModel = new ModelRendererTurbo[4])[0] = new ModelRendererTurbo(this, 0, 104, textureX, textureY);
        ...
        (this.bodyWheelModel = new ModelRendererTurbo[4])[0] = new ModelRendererTurbo(this, 116, 48, textureX, textureY);
        ...
        (this.noseModel[0] = new ModelRendererTurbo(this, 0, 38, textureX, textureY)).addTrapezoid(-51.0f, -16.0f, -10.0f, 48, 18, 20, 0.0f, -3.0f, 3);
        this.noseModel[0].setPosition(0.0f, 5.0f, 0.0f);
        (this.noseModel[1] = new ModelRendererTurbo(this, 172, 12, textureX, textureY)).func_78790_a(0.0f, -2.0f, 0.0f, 4, 4, 4, 0.0f);
        this.noseModel[1].setPosition(-55.0f, 0.0f, -2.0f);
        this.tailModel = new ModelRendererTurbo[1];
        (this.tailModel[0] = new ModelRendererTurbo(this, 0, 0, textureX, textureY)).addTrapezoid(17.0f, -16.0f, -10.0f, 76, 18, 20, 0.0f, -3.0f, 2);
        this.tailModel[0].setPosition(0.0f, 5.0f, 0.0f);
        (this.tailWheelModel = new ModelRendererTurbo[2])[0] = new ModelRendererTurbo(this, 116, 48, textureX, textureY);
        ...
        (this.rightWingModel = new ModelRendererTurbo[3])[0] = new ModelRendererTurbo(this, 58, 48, textureX, textureY);
        ...
        (this.leftWingModel = new ModelRendererTurbo[3])[0] = new ModelRendererTurbo(this, 58, 48, textureX, textureY);
        ...
        (this.yawFlapModel[0] = new ModelRendererTurbo(this, 220, 12, textureX, textureY)).func_78790_a(0.0f, 0.0f, 0.0f, 16, 20, 2, 0.0f);
        this.yawFlapModel[0].setPosition(76.0f, -22.0f, -1.0f);
        this.pitchFlapLeftModel = new ModelRendererTurbo[1];
        (this.pitchFlapLeftModel[0] = new ModelRendererTurbo(this, 220, 12, textureX, textureY)).func_78790_a(0.0f, 0.0f, 0.0f, 16, 22, 2, 0.0f);
        ...
        (this.pitchFlapRightModel[0] = new ModelRendererTurbo(this, 220, 12, textureX, textureY)).func_78790_a(0.0f, 0.0f, 0.0f, 16, 22, 2, 0.0f);
