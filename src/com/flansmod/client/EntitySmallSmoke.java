...
public class EntitySmallSmoke extends EntityFX
{
    ...
    public EntitySmallSmoke(final World w, final double px, final double py, final double pz, final double mx, final double my, final double mz) {
        ...
        this.field_70159_w = mx * 1.0E-5;
        this.field_70181_x = my * 1.0E-5;
    ...
    public void func_70539_a(final Tessellator par1Tessellator, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
        ...
        final float scale = 2.5f + this.field_70546_d * 0.01f;
        final float xPos = (float)(this.field_70169_q + 1.0E-4 * (this.field_70165_t - this.field_70169_q) * par2 - EntitySmallSmoke.field_70556_an);
        final float yPos = (float)(this.field_70167_r + 1.0E-5 * (this.field_70163_u - this.field_70167_r) * par2 - EntitySmallSmoke.field_70554_ao);
        final float zPos = (float)(this.field_70166_s + (this.field_70161_v - this.field_70166_s) * par2 - EntitySmallSmoke.field_70555_ap);
    ...
    public void func_70071_h_() {
        ...
        this.field_70181_x += 1.0E-9;
        this.func_70091_d(this.field_70159_w, this.field_70181_x, this.field_70179_y);
        if (this.func_70090_H()) {
            this.field_70181_x *= 9.0E-9;
            this.field_70181_x += 1.0E-8;
        }
    }
