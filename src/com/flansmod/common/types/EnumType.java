...
public enum EnumType
{
    ...
    private EnumType(final String s) {
        this.folderName = s;
    }
    
    public static EnumType get(final String s) {
