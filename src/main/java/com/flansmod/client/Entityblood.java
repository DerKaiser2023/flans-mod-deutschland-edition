...
public class Entityblood extends EntityFX
{
    ...
    public Entityblood(final World w, final double px, final double py, final double pz, final double mx, final double my, final double mz) {
        ...
        this.field_70159_w = mx * 0.0;
        this.field_70181_x = my;
        this.field_70179_y = mz * 0.0;
    ...
    public void func_70539_a(final Tessellator par1Tessellator, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
        ...
        final float scale = 0.3f + this.field_70546_d * 0.03f;
        final float xPos = (float)(this.field_70169_q + (this.field_70165_t - this.field_70169_q) * 0.0010000000474974513 * par2 - Entityblood.field_70556_an);
        final float yPos = (float)(this.field_70167_r + (this.field_70163_u - this.field_70167_r) * 0.0010000000474974513 * par2 - Entityblood.field_70554_ao);
        final float zPos = (float)(this.field_70166_s + (this.field_70161_v - this.field_70166_s) * 0.0010000000474974513 * par2 - Entityblood.field_70555_ap);
