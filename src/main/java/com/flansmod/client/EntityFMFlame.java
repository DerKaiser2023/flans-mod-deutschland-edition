...
public class EntityFMFlame extends EntityFX
{
    ...
    public EntityFMFlame(final World w, final double px, final double py, final double pz, final double mx, final double my, final double mz) {
        ...
        EntityFMFlame.icon = new ResourceLocation("flansmod", "particle/FMFlame.png");
    }
    ...
    public void renderParticle(final Tessellator par1Tessellator, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
        ...
        final float xPos = (float)(this.prevPosX + (this.posX - this.prevPosX) * par2 - EntityFMFlame.interpPosX);
        final float yPos = (float)(this.prevPosY + (this.posY - this.prevPosY) * par2 - EntityFMFlame.interpPosY);
        final float zPos = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * par2 - EntityFMFlame.interpPosZ);
