...
public class EntitytankDeath extends EntityFX
{
    ...
    public EntitytankDeath(final World w, final double px, final double py, final double pz, final double mx, final double my, final double mz) {
        ...
        EntitytankDeath.icon = new ResourceLocation("flansmod", "particle/FMFlame.png");
    }
    ...
    public void renderParticle(final Tessellator par1Tessellator, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
        ...
        final float scale = 0.1f + this.particleAge * 12.0f - this.particleAge * this.particleAge * 1.5f;
        final float xPos = (float)(this.prevPosX + (this.posX - this.prevPosX) * par2 - EntitytankDeath.interpPosX);
        final float yPos = (float)(this.prevPosY + (this.posY - this.prevPosY) * par2 - EntitytankDeath.interpPosY);
        final float zPos = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * par2 - EntitytankDeath.interpPosZ);
        final float colorIntensity = 1.0f;
        par1Tessellator.setColorRGBA_F(this.particleRed * colorIntensity, this.particleGreen * 0.0f, this.particleBlue * 0.0f, 1.0f - this.particleAge * this.particleAge * this.particleAge * 9.0E-4f);
