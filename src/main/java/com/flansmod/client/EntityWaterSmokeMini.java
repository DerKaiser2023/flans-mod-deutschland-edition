...
public class EntityWaterSmokeMini extends EntityFX
{
    ...
    public void renderParticle(final Tessellator par1Tessellator, final float par2, final float par3, final float par4, final float par5, final float par6, final float par7) {
        ...
        final float scale = 1.0f + this.particleAge * 0.01f;
        final float xPos = (float)(this.prevPosX + (this.posX - this.prevPosX) * par2 - EntityWaterSmokeMini.interpPosX);
        final float yPos = (float)(this.prevPosY + (this.posY - this.prevPosY) * par2 - EntityWaterSmokeMini.interpPosY);
        final float zPos = (float)(this.prevPosZ + (this.posZ - this.prevPosZ) * par2 - EntityWaterSmokeMini.interpPosZ);
