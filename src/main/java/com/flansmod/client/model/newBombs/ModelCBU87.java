...
public class ModelCBU87 extends ModelBase
{
    ...
    public ModelCBU87() {
        ...
        this.cbu87Model[0].setRotationPoint(-2.0f, -17.0f, -4.0f);
        ...
        this.cbu87Model[1].setRotationPoint(2.0f, -17.0f, -4.0f);
        ...
        this.cbu87Model[2].setRotationPoint(-4.0f, -17.0f, -4.0f);
        ...
        this.cbu87Model[3].setRotationPoint(2.0f, 18.0f, -4.0f);
        ...
        this.cbu87Model[4].setRotationPoint(-2.0f, 18.0f, -4.0f);
        ...
        this.cbu87Model[5].setRotationPoint(-4.0f, 18.0f, -4.0f);
        ...
        this.cbu87Model[6].setRotationPoint(2.0f, -22.0f, -4.0f);
        ...
        this.cbu87Model[7].setRotationPoint(-2.0f, -22.0f, -4.0f);
        ...
        this.cbu87Model[8].setRotationPoint(-4.0f, -22.0f, -4.0f);
        ...
        this.cbu87Model[9].setRotationPoint(-0.5f, -22.0f, -4.0f);
        ...
        this.cbu87Model[10].setRotationPoint(-4.0f, -22.0f, -0.5f);
        ...
        this.cbu87Model[11].setRotationPoint(-0.5f, -22.0f, 1.0f);
        ...
        this.cbu87Model[12].setRotationPoint(1.0f, -22.0f, -0.5f);
    }
    
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        for (int i = 0; i < 13; ++i) {
            this.cbu87Model[i].render(f5);
        }
    }
