...
public class ModelThompson extends ModelGun
{
    ...
    public ModelThompson() {
        ...
        (this.ammoModel[0] = new ModelRendererTurbo(this, 81, 17, this.textureX, this.textureY)).func_78790_a(12.0f, -11.0f, -2.0f, 4, 16, 4, 0.0f);
        this.ammoModel[0].func_78793_a(0.0f, 0.0f, 0.0f);
        this.slideModel = new ModelRendererTurbo[1];
        (this.slideModel[0] = new ModelRendererTurbo(this, 105, 1, this.textureX, this.textureY)).func_78790_a(0.0f, 0.0f, 0.0f, 1, 1, 2, 0.0f);
