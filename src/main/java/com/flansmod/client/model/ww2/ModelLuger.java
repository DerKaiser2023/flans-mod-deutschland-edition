...
public class ModelLuger extends ModelGun
{
    ...
    public ModelLuger() {
        ...
        this.gunModel[1].addBox(0.0f, 0.0f, 0.0f, 4, 2, 2, 0.0f);
        this.gunModel[1].setRotationPoint(-0.4f, -4.0f, -1.0f);
        this.gunModel[2].addBox(0.0f, 0.0f, 0.0f, 5, 1, 1, 0.0f);
        this.gunModel[2].setRotationPoint(3.0f, -3.8f, -0.5f);
        this.gunModel[3].addBox(0.0f, 0.0f, 0.0f, 1, 1, 1, 0.0f);
        this.gunModel[3].setRotationPoint(6.8f, -4.2f, -0.5f);
        this.gunModel[4].addBox(0.0f, 0.0f, 0.0f, 0, 2, 1, 0.0f);
        this.gunModel[4].setRotationPoint(3.0f, -2.4f, -0.5f);
        this.gunModel[4].rotateAngleZ = -0.8552113f;
        this.ammoModel = new ModelRendererTurbo[1];
        (this.ammoModel[0] = new ModelRendererTurbo(this, 126, 150, this.textureX, this.textureY)).addBox(0.0f, -3.0f, -0.5f, 1, 4, 1, 0.0f);
        ...
        (this.slideModel[0] = new ModelRendererTurbo(this, 100, 165, this.textureX, this.textureY)).addBox(0.0f, 0.0f, 0.0f, 1, 1, 3, 0.0f);
        this.slideModel[0].setRotationPoint(1.0f, -3.8f, -1.5f);
