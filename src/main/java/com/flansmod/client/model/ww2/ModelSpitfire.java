...
public class ModelSpitfire extends ModelPlane
{
    public ModelSpitfire() {
        ...
        (this.noseModel[1] = new ModelRendererTurbo(this, 172, 12, textureX, textureY)).addBox(0.0f, -2.0f, 0.0f, 4, 4, 4, 0.0f);
        ...
        (this.yawFlapModel[0] = new ModelRendererTurbo(this, 220, 12, textureX, textureY)).addBox(0.0f, 0.0f, 0.0f, 16, 20, 2, 0.0f);
        this.yawFlapModel[0].setPosition(76.0f, -22.0f, -1.0f);
        this.pitchFlapLeftModel = new ModelRendererTurbo[1];
        (this.pitchFlapLeftModel[0] = new ModelRendererTurbo(this, 220, 12, textureX, textureY)).addBox(0.0f, 0.0f, 0.0f, 16, 22, 2, 0.0f);
        ...
        (this.pitchFlapRightModel[0] = new ModelRendererTurbo(this, 220, 12, textureX, textureY)).addBox(0.0f, 0.0f, 0.0f, 16, 22, 2, 0.0f);
