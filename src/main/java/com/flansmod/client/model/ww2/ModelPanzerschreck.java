...
public class ModelPanzerschreck extends ModelGun
{
    ...
    public ModelPanzerschreck() {
        ...
        this.gunModel[0].addBox(0.0f, 0.0f, 0.0f, 26, 3, 3, 0.0f);
        this.gunModel[0].setRotationPoint(-18.0f, -4.5f, -1.5f);
        this.gunModel[1].addBox(0.0f, 0.0f, 0.0f, 0, 9, 11, 0.0f);
        this.gunModel[1].setRotationPoint(3.0f, -7.0f, -3.0f);
        this.gunModel[1].rotateAngleY = 0.01745329f;
        this.gunModel[2].addBox(0.0f, 0.0f, 0.0f, 1, 4, 1, 0.0f);
        this.gunModel[2].setRotationPoint(0.8f, -2.2f, -0.5f);
        this.gunModel[3].addBox(0.0f, 0.0f, 0.0f, 1, 2, 2, 0.0f);
        this.gunModel[3].setRotationPoint(-18.5f, -4.0f, -1.0f);
        this.gunModel[4].addBox(0.0f, 0.0f, 0.0f, 1, 4, 1, 0.0f);
        this.gunModel[4].setRotationPoint(-19.0f, -5.0f, 1.0f);
        this.gunModel[5].addBox(0.0f, 0.0f, 0.0f, 1, 1, 3, 0.0f);
        this.gunModel[5].setRotationPoint(-19.0f, -5.0f, -2.0f);
        this.gunModel[6].addBox(0.0f, 0.0f, 0.0f, 1, 1, 3, 0.0f);
        this.gunModel[6].setRotationPoint(-19.0f, -2.0f, -2.0f);
        this.gunModel[7].addBox(0.0f, 0.0f, 0.0f, 1, 2, 1, 0.0f);
        this.gunModel[7].setRotationPoint(-19.0f, -4.0f, -2.0f);
        this.ammoModel = new ModelRendererTurbo[1];
        (this.ammoModel[0] = new ModelRendererTurbo(this, 0, 0, this.textureX, this.textureY)).addBox(-18.0f, -4.0f, -1.0f, 7, 2, 2, 0.0f);
