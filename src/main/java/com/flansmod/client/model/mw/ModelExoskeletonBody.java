...
public class ModelExoskeletonBody extends ModelCustomArmour
{
    ...
    public ModelExoskeletonBody() {
        this.textureX = 512;
        this.textureY = 512;
        (this.bodyModel = new ModelRendererTurbo[33])[0] = new ModelRendererTurbo((ModelBase)this, 145, 41, this.textureX, this.textureY);
        ...
        (this.rightArmModel = new ModelRendererTurbo[13])[0] = new ModelRendererTurbo((ModelBase)this, 457, 17, this.textureX, this.textureY);
        ...
        final float armOffsetX = 20.0f;
        final float armOffsetY = 60.0f;
        final float armOffsetZ = -1.0f;
        ...
        (this.leftArmModel = new ModelRendererTurbo[13])[0] = new ModelRendererTurbo((ModelBase)this, 337, 49, this.textureX, this.textureY);
