...
public class ModelJian extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[1].setRotationPoint(0.2f, -14.0f, 0.5f);
        ...
        this.gunModel[2].setRotationPoint(0.2f, -16.5f, 0.5f);
        ...
        this.gunModel[3].setRotationPoint(0.2f, -2.5f, 0.5f);
        ...
        this.gunModel[4].setRotationPoint(0.2f, 1.5f, 0.5f);
        ...
        this.gunModel[6].setRotationPoint(0.2f, 1.0f, 0.5f);
        ...
        this.gunModel[7].setRotationPoint(0.2f, -0.5f, 0.5f);
        ...
        this.gunModel[8].setRotationPoint(0.2f, -1.5f, 0.5f);
