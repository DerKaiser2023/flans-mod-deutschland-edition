...
public class ModelAruval extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(0.2f, -17.0f, 0.5f);
        ...
        this.gunModel[1].setRotationPoint(0.2f, -2.0f, 0.5f);
        ...
        this.gunModel[2].setRotationPoint(0.2f, 1.0f, 0.5f);
        ...
        this.gunModel[3].setRotationPoint(0.2f, -18.0f, 0.5f);
        ...
        this.gunModel[4].setRotationPoint(0.2f, -19.3f, 0.5f);
        ...
        this.gunModel[5].setRotationPoint(0.2f, -20.3f, 0.5f);
        ...
        this.gunModel[6].setRotationPoint(0.2f, -20.3f, 0.5f);
        ...
        this.gunModel[7].setRotationPoint(0.2f, -20.9f, 0.5f);
        ...
        this.gunModel[8].setRotationPoint(0.2f, -20.3f, 0.5f);
        ...
        this.gunModel[9].setRotationPoint(0.2f, -8.0f, 0.5f);
