...
public class ModelMaul extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(0.3f, -7.0f, 0.5f);
        ...
        this.gunModel[1].setRotationPoint(0.3f, -15.0f, 0.5f);
        ...
        this.gunModel[2].setRotationPoint(-2.2f, -10.0f, -1.0f);
        ...
        this.gunModel[3].setRotationPoint(-2.2f, -11.75f, -1.0f);
        ...
        this.gunModel[4].setRotationPoint(-2.2f, -8.25f, -1.0f);
    }
}
