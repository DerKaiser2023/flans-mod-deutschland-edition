...
public class ModelPilum extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(-28.0f, -3.0f, 0.0f);
        ...
        this.gunModel[1].setRotationPoint(2.0f, -3.0f, 0.0f);
        ...
        this.gunModel[2].setRotationPoint(6.0f, -3.0f, 0.0f);
        ...
        this.gunModel[3].setRotationPoint(17.0f, -3.0f, 0.0f);
    }
}
