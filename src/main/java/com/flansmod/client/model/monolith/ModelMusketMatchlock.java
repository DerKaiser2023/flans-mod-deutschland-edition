...
public class ModelMusketMatchlock extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(5.0f, -4.5f, -1.0f);
        ...
        this.gunModel[1].setRotationPoint(-11.5f, -4.0f, -1.0f);
        ...
        this.gunModel[2].setRotationPoint(-2.0f, -3.0f, -1.0f);
        ...
        this.gunModel[3].setRotationPoint(2.0f, -4.9f, -0.5f);
        ...
        this.gunModel[4].setRotationPoint(28.0f, -4.9f, -0.5f);
        ...
        this.gunModel[5].setRotationPoint(-4.0f, -4.0f, -1.0f);
        ...
        this.gunModel[6].setRotationPoint(22.0f, -4.5f, -1.0f);
        ...
        this.gunModel[7].setRotationPoint(22.0f, -3.8f, -0.5f);
        ...
        this.gunModel[8].setRotationPoint(-3.0f, -3.5f, -1.2f);
        ...
        this.gunModel[9].setRotationPoint(0.2f, -2.5f, -0.5f);
        ...
        this.gunModel[10].setRotationPoint(-0.8f, -0.8f, -0.5f);
        ...
        this.gunModel[11].setRotationPoint(3.0f, -4.3f, -1.9f);
        ...
        this.gunModel[12].setRotationPoint(3.5f, -5.6f, -1.9f);
        ...
        this.gunModel[13].setRotationPoint(3.2f, -4.7f, -1.9f);
        ...
        this.gunModel[14].setRotationPoint(3.0f, -6.4f, -1.9f);
        ...
        this.gunModel[15].setRotationPoint(2.7f, -6.4f, -1.4f);
        ...
        this.gunModel[16].setRotationPoint(-2.0f, -4.9f, -0.5f);
        ...
        this.gunModel[17].setRotationPoint(-1.5f, -5.6f, -1.4f);
        ...
        this.gunModel[18].setRotationPoint(2.7f, -6.2f, -1.2f);
        ...
        this.gunModel[19].setRotationPoint(4.5f, -6.2f, -1.2f);
        this.gunModel[19].rotateAngleY = -0.54105204f;
        this.gunModel[19].rotateAngleZ = -0.7679449f;
        ...
        this.gunModel[20].setRotationPoint(5.0f, -5.0f, -1.7f);
        this.gunModel[20].rotateAngleY = -0.27925268f;
        ...
        this.gunModel[21].setRotationPoint(-5.0f, -4.0f, -1.0f);
        ...
        this.gunModel[22].setRotationPoint(-6.0f, -4.0f, -1.0f);
        ...
        this.gunModel[23].setRotationPoint(-13.5f, -4.0f, -1.0f);
        ...
        this.gunModel[24].setRotationPoint(-0.8f, -0.8f, -0.5f);
        this.gunModel[24].rotateAngleZ = 0.7853982f;
        ...
        this.gunModel[25].setRotationPoint(-1.5f, -2.0f, -0.5f);
        this.gunModel[25].rotateAngleZ = -0.5235988f;
        ...
        this.gunModel[26].setRotationPoint(-1.3f, -2.0f, -0.5f);
        this.gunModel[26].rotateAngleZ = 0.17453294f;
    }
    ...
    private void initammoModel_1() {
        ...
        this.ammoModel[0].setRotationPoint(29.0f, -4.8f, -0.5f);
