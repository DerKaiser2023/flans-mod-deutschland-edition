...
public class ModelHercules extends ModelVehicle
{
    ...
    private void initbarrelModel_1() {
        ...
        this.barrelModel[1] = new ModelRendererTurbo(this, 145, 1, this.textureX, this.textureY);
        this.barrelModel[2] = new ModelRendererTurbo(this, 233, 1, this.textureX, this.textureY);
        this.barrelModel[3] = new ModelRendererTurbo(this, 329, 1, this.textureX, this.textureY);
        this.barrelModel[4] = new ModelRendererTurbo(this, 401, 1, this.textureX, this.textureY);
        this.barrelModel[5] = new ModelRendererTurbo(this, 457, 1, this.textureX, this.textureY);
        ...
        this.barrelModel[8] = new ModelRendererTurbo(this, 57, 25, this.textureX, this.textureY);
        this.barrelModel[9] = new ModelRendererTurbo(this, 289, 33, this.textureX, this.textureY);
        ...
        this.barrelModel[12] = new ModelRendererTurbo(this, 425, 25, this.textureX, this.textureY);
        this.barrelModel[13] = new ModelRendererTurbo(this, 265, 57, this.textureX, this.textureY);
        this.barrelModel[14] = new ModelRendererTurbo(this, 337, 57, this.textureX, this.textureY);
        this.barrelModel[15] = new ModelRendererTurbo(this, 1, 73, this.textureX, this.textureY);
        this.barrelModel[16] = new ModelRendererTurbo(this, 113, 73, this.textureX, this.textureY);
        this.barrelModel[17] = new ModelRendererTurbo(this, 209, 81, this.textureX, this.textureY);
