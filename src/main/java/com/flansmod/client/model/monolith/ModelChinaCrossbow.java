...
public class ModelChinaCrossbow extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(2.0f, -3.0f, -1.0f);
        ...
        this.gunModel[1].setRotationPoint(-3.0f, -3.0f, -1.0f);
        ...
        this.gunModel[2].setRotationPoint(11.0f, -3.0f, -1.0f);
        ...
        this.gunModel[3].setRotationPoint(-2.8f, -1.0f, -0.5f);
        ...
        this.gunModel[4].setRotationPoint(0.2f, -1.0f, -0.5f);
        ...
        this.gunModel[5].setRotationPoint(-2.8f, -0.3f, -0.5f);
        ...
        this.gunModel[6].setRotationPoint(-1.8f, -1.2f, -0.5f);
        ...
        this.gunModel[7].setRotationPoint(-1.8f, -3.5f, -0.5f);
        ...
        this.gunModel[8].setRotationPoint(15.5f, -2.5f, 0.0f);
        this.gunModel[8].rotateAngleY = -0.2268928f;
        ...
        this.gunModel[9].setRotationPoint(15.5f, -2.5f, 0.0f);
        this.gunModel[9].rotateAngleY = 0.2268928f;
        ...
        this.gunModel[10].setRotationPoint(16.2f, -2.5f, 2.7f);
        this.gunModel[10].rotateAngleY = -0.05235988f;
        ...
        this.gunModel[11].setRotationPoint(16.2f, -2.5f, -2.7f);
        this.gunModel[11].rotateAngleY = 0.05235988f;
        ...
        this.gunModel[12].setRotationPoint(16.4f, -2.5f, 6.3f);
        this.gunModel[12].rotateAngleY = 0.34906584f;
        ...
        this.gunModel[13].setRotationPoint(16.4f, -2.5f, -6.3f);
        this.gunModel[13].rotateAngleY = -0.34906584f;
        ...
        this.gunModel[14].setRotationPoint(11.5f, -2.5f, -2.5f);
        ...
        this.gunModel[15].setRotationPoint(11.5f, -2.5f, -2.4f);
        ...
        this.gunModel[16].setRotationPoint(16.7f, -2.5f, -2.4f);
        ...
        this.gunModel[17].setRotationPoint(11.5f, -2.5f, 1.4f);
        ...
        this.gunModel[18].setRotationPoint(16.7f, -2.5f, 1.4f);
        ...
        this.gunModel[19].setRotationPoint(-2.0f, -3.8f, -0.5f);
        this.gunModel[19].rotateAngleY = 0.6806784f;
        ...
        this.gunModel[20].setRotationPoint(-2.6f, -3.8f, -0.1f);
        this.gunModel[20].rotateAngleY = -0.6806784f;
    ...
    private void initammoModel_1() {
        ...
        this.ammoModel[0].setRotationPoint(-1.0f, -3.8f, -0.5f);
        ...
        this.ammoModel[1].setRotationPoint(14.0f, -3.8f, -0.5f);
        ...
        this.ammoModel[2].setRotationPoint(15.0f, -3.8f, -0.5f);
