...
public class ModelThreeEye extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(-11.0f, -2.8f, 0.0f);
        ...
        this.gunModel[1].setRotationPoint(16.0f, -5.0f, -0.5f);
        ...
        this.gunModel[2].setRotationPoint(2.0f, -3.3f, -0.5f);
        ...
        this.gunModel[3].setRotationPoint(21.5f, -5.0f, -0.5f);
        ...
        this.gunModel[4].setRotationPoint(28.0f, -5.0f, -0.5f);
        ...
        this.gunModel[5].setRotationPoint(24.5f, -5.0f, -0.5f);
        ...
        this.gunModel[6].setRotationPoint(21.0f, -5.0f, -0.5f);
        ...
        this.gunModel[7].setRotationPoint(16.0f, -2.3f, -2.0f);
        this.gunModel[7].rotateAngleX = -0.17453294f;
        ...
        this.gunModel[8].setRotationPoint(21.0f, -2.3f, -2.0f);
        this.gunModel[8].rotateAngleX = -0.17453294f;
        ...
        this.gunModel[9].setRotationPoint(24.5f, -2.3f, -2.0f);
        this.gunModel[9].rotateAngleX = -0.17453294f;
        ...
        this.gunModel[10].setRotationPoint(28.0f, -2.3f, -2.0f);
        this.gunModel[10].rotateAngleX = -0.17453294f;
        ...
        this.gunModel[11].setRotationPoint(21.5f, -2.3f, -2.0f);
        this.gunModel[11].rotateAngleX = -0.17453294f;
        ...
        this.gunModel[12].setRotationPoint(16.0f, -2.3f, 3.0f);
        this.gunModel[12].rotateAngleX = 0.17453294f;
        ...
        this.gunModel[13].setRotationPoint(21.0f, -2.3f, 3.0f);
        this.gunModel[13].rotateAngleX = 0.17453294f;
        ...
        this.gunModel[14].setRotationPoint(24.5f, -2.3f, 3.0f);
        this.gunModel[14].rotateAngleX = 0.17453294f;
        ...
        this.gunModel[15].setRotationPoint(28.0f, -2.3f, 3.0f);
        this.gunModel[15].rotateAngleX = 0.17453294f;
        ...
        this.gunModel[16].setRotationPoint(21.5f, -2.3f, 3.0f);
        this.gunModel[16].rotateAngleX = 0.17453294f;
        ...
        this.gunModel[17].setRotationPoint(11.8f, -3.8f, -0.5f);
        this.gunModel[17].rotateAngleZ = 0.2268928f;
        ...
        this.gunModel[18].setRotationPoint(11.8f, -0.8f, 1.0f);
        this.gunModel[18].rotateAngleX = 0.17453294f;
        this.gunModel[18].rotateAngleY = 0.2617994f;
        this.gunModel[18].rotateAngleZ = -0.13962634f;
        ...
        this.gunModel[19].setRotationPoint(11.8f, -0.8f, 0.0f);
        this.gunModel[19].rotateAngleX = -0.17453294f;
        this.gunModel[19].rotateAngleY = -0.2617994f;
        this.gunModel[19].rotateAngleZ = -0.13962634f;
    }
}
