...
public class ModelKatana extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(0.2f, -18.5f, 0.5f);
        ...
        this.gunModel[1].setRotationPoint(0.2f, -21.0f, 0.5f);
        ...
        this.gunModel[6].setRotationPoint(0.2f, -14.5f, 0.5f);
        ...
        this.gunModel[7].setRotationPoint(0.2f, -10.5f, 0.5f);
        ...
        this.gunModel[8].setRotationPoint(0.2f, -6.5f, 0.5f);
        ...
        this.gunModel[9].setRotationPoint(0.2f, -3.5f, 0.5f);
