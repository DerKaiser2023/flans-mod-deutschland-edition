...
public class ModelArquebusMatchlock extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(5.0f, -3.5f, -1.0f);
        ...
        this.gunModel[1].setRotationPoint(-14.0f, -4.0f, -1.0f);
        ...
        this.gunModel[4].setRotationPoint(22.0f, -4.9f, -0.5f);
        ...
        this.gunModel[5].setRotationPoint(-6.0f, -4.0f, -1.0f);
        ...
        this.gunModel[6].setRotationPoint(16.0f, -3.5f, -1.0f);
        ...
        this.gunModel[10].setRotationPoint(-5.8f, -4.440892E-16f, -0.5f);
        this.gunModel[10].rotateAngleZ = 0.27925268f;
    ...
    private void initammoModel_1() {
        ...
        this.ammoModel[0].setRotationPoint(23.0f, -4.8f, -0.5f);
