...
public class ModelEgyptShield extends ModelGun
{
    ...
    public ModelEgyptShield() {
        ...
        this.gunModel[0].setRotationPoint(-0.5f, -2.0f, -0.5f);
        ...
        this.gunModel[1].setRotationPoint(1.5f, -4.0f, -0.5f);
        ...
        this.gunModel[2].setRotationPoint(-0.5f, 1.0f, -0.5f);
        ...
        this.gunModel[3].setRotationPoint(1.5f, -8.0f, 0.0f);
        ...
        this.gunModel[4].setRotationPoint(1.5f, -8.0f, -4.0f);
        ...
        this.gunModel[5].setRotationPoint(-0.5f, -2.0f, -0.5f);
