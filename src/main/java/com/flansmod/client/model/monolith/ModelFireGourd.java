...
public class ModelFireGourd extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(-12.0f, -2.8f, 0.0f);
        ...
        this.gunModel[1].setRotationPoint(6.0f, -3.3f, -0.5f);
    }
    ...
    private void initammoModel_1() {
        ...
        this.ammoModel[0].setRotationPoint(12.0f, -3.3f, -0.5f);
        ...
        this.ammoModel[1].setRotationPoint(13.0f, -4.8f, -2.0f);
        ...
        this.ammoModel[2].setRotationPoint(15.0f, -4.8f, -2.0f);
        ...
        this.ammoModel[3].setRotationPoint(16.0f, -3.3f, -0.5f);
        ...
        this.ammoModel[4].setRotationPoint(17.0f, -3.3f, -0.5f);
        ...
        this.ammoModel[5].setRotationPoint(18.5f, -3.3f, -0.5f);
        ...
        this.ammoModel[6].setRotationPoint(19.5f, -3.3f, -0.5f);
        ...
        this.ammoModel[7].setRotationPoint(20.5f, -3.3f, -0.5f);
    }
}
