...
public class ModelDao extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[5].setRotationPoint(0.2f, 0.5f, 0.5f);
        ...
        this.gunModel[6].setRotationPoint(0.2f, 0.4f, 0.5f);
        ...
        this.gunModel[8].setRotationPoint(0.2f, 0.5f, 0.5f);
        ...
        this.gunModel[9].setRotationPoint(0.2f, 0.4f, 0.5f);
        ...
        this.gunModel[10].setRotationPoint(0.2f, 0.5f, 0.5f);
