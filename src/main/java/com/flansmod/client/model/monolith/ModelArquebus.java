...
public class ModelArquebus extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(0.0f, -1.5f, 1.0f);
        ...
        this.gunModel[1].setRotationPoint(-14.0f, -2.0f, 1.0f);
        ...
        this.gunModel[2].setRotationPoint(-3.0f, -2.0f, 1.0f);
        ...
        this.gunModel[3].setRotationPoint(0.0f, -2.5f, 1.5f);
        ...
        this.gunModel[4].setRotationPoint(24.0f, -2.5f, 1.5f);
        ...
        this.gunModel[5].setRotationPoint(4.0f, -2.6f, 1.0f);
        ...
        this.gunModel[6].setRotationPoint(16.0f, -2.6f, 1.0f);
        ...
        this.gunModel[7].setRotationPoint(16.0f, -1.6f, 0.0f);
        ...
        this.gunModel[8].setRotationPoint(16.0f, -1.6f, 3.0f);
        ...
        this.gunModel[9].setRotationPoint(16.0f, 1.2f, 3.0f);
        this.gunModel[9].rotateAngleX = -0.5235988f;
        ...
        this.gunModel[10].setRotationPoint(16.0f, 1.6f, 0.2f);
        this.gunModel[10].rotateAngleX = 0.5235988f;
        ...
        this.gunModel[11].setRotationPoint(16.0f, 3.6f, 1.5f);
    }
    ...
    private void initammoModel_1() {
        ...
        this.ammoModel[0].setRotationPoint(0.5f, -3.0f, 0.0f);
        this.ammoModel[0].rotateAngleY = -1.5707964f;
        ...
        this.ammoModel[1].setRotationPoint(23.5f, -2.5f, 1.5f);
