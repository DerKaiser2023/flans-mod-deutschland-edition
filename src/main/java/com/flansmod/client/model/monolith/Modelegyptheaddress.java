...
public class Modelegyptheaddress extends ModelCustomArmour
{
    ...
    public Modelegyptheaddress() {
        ...
        this.headModel[1].addBox(-4.0f, -8.0f, -4.0f, 8, 2, 9, 0.0f);
        this.headModel[1].setRotationPoint(0.0f, 0.0f, 0.0f);
        this.headModel[2].addBox(-4.0f, -8.0f, 4.0f, 8, 8, 1, 0.0f);
        this.headModel[2].setRotationPoint(0.0f, 0.0f, 0.0f);
        this.headModel[3].addBox(-5.0f, -7.5f, -3.0f, 1, 7, 7, 0.0f);
        this.headModel[3].setRotationPoint(0.0f, 0.0f, 0.0f);
        this.headModel[4].addBox(4.0f, -7.5f, -3.0f, 1, 7, 7, 0.0f);
