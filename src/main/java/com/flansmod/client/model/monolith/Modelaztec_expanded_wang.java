...
public class Modelaztec_expanded_wang extends ModelGun
{
    ...
    public Modelaztec_expanded_wang() {
        ...
        this.gunModel[11] = new ModelRendererTurbo(this, 81, 1, this.textureX, this.textureY);
        this.gunModel[12] = new ModelRendererTurbo(this, 81, 1, this.textureX, this.textureY);
        ...
        this.gunModel[0].setRotationPoint(-1.0f, -16.0f, -0.5f);
        ...
        this.gunModel[1].setRotationPoint(-0.5f, -3.0f, -0.5f);
        ...
        this.gunModel[2].setRotationPoint(-1.0f, -4.0f, -0.5f);
        ...
        this.gunModel[3].setRotationPoint(1.0f, -13.0f, -0.5f);
        ...
        this.gunModel[4].setRotationPoint(1.0f, -11.0f, -0.5f);
        ...
        this.gunModel[5].setRotationPoint(1.0f, -9.0f, -0.5f);
        ...
        this.gunModel[6].setRotationPoint(1.0f, -7.0f, -0.5f);
        ...
        this.gunModel[7].setRotationPoint(-2.0f, -7.0f, -0.5f);
        ...
        this.gunModel[8].setRotationPoint(-2.0f, -9.0f, -0.5f);
        ...
        this.gunModel[9].setRotationPoint(-2.0f, -11.0f, -0.5f);
        ...
        this.gunModel[10].setRotationPoint(-2.0f, -13.0f, -0.5f);
        ...
        this.gunModel[11].setRotationPoint(-2.0f, -15.0f, -0.5f);
        ...
        this.gunModel[12].setRotationPoint(1.0f, -15.0f, -0.5f);
