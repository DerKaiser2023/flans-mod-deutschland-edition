...
public class ModelShamshir extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].setRotationPoint(0.2f, -9.0f, 0.5f);
        ...
        this.gunModel[3].setRotationPoint(0.2f, -3.0f, 0.5f);
        ...
        this.gunModel[4].setRotationPoint(0.2f, -3.0f, 0.5f);
        ...
        this.gunModel[5].setRotationPoint(0.2f, -3.0f, 0.5f);
        ...
        this.gunModel[6].setRotationPoint(0.2f, -2.5f, 0.5f);
        ...
        this.gunModel[7].setRotationPoint(0.2f, -2.5f, 0.5f);
        ...
        this.gunModel[9].setRotationPoint(0.2f, -14.5f, 0.5f);
        ...
        this.gunModel[10].setRotationPoint(0.2f, -14.5f, 0.5f);
