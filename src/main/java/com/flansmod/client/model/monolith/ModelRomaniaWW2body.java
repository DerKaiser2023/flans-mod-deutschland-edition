...
public class ModelRomaniaWW2body extends ModelCustomArmour
{
    ...
    private void initbodyModel_1() {
        ...
        this.bodyModel[42].setRotationPoint(0.0f, -5.0f, 0.0f);
        this.bodyModel[43].addBox(-3.9f, 8.0f, -2.25f, 3, 2, 1, 0.0f);
        this.bodyModel[43].setRotationPoint(0.0f, -5.0f, 0.0f);
        this.bodyModel[44].addBox(0.9f, 7.0f, -2.3f, 3, 1, 1, 0.0f);
        this.bodyModel[44].setRotationPoint(0.0f, -5.0f, 0.0f);
        this.bodyModel[45].addBox(0.9f, 8.0f, -2.25f, 3, 2, 1, 0.0f);
        this.bodyModel[45].setRotationPoint(0.0f, -5.0f, 0.0f);
