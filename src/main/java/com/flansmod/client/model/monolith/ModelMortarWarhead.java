...
public class ModelMortarWarhead extends ModelBase
{
    ...
    public ModelMortarWarhead() {
        ...
        this.MortarWarheadModel[0].setRotationPoint(-0.5f, 26.0f, -0.5f);
        ...
        this.MortarWarheadModel[1].setRotationPoint(-0.5f, 25.5f, -0.5f);
        ...
        this.MortarWarheadModel[2].setRotationPoint(-0.5f, 23.5f, -0.5f);
        ...
        this.MortarWarheadModel[3].setRotationPoint(-0.5f, 20.5f, -0.5f);
        ...
        this.MortarWarheadModel[4].setRotationPoint(-0.5f, 16.0f, -0.5f);
        ...
        this.MortarWarheadModel[5].setRotationPoint(-0.5f, 16.5f, -1.5f);
        ...
        this.MortarWarheadModel[6].setRotationPoint(-0.5f, 19.0f, -1.5f);
        ...
        this.MortarWarheadModel[7].setRotationPoint(-1.5f, 19.0f, -0.5f);
        ...
        this.MortarWarheadModel[8].setRotationPoint(-1.5f, 16.5f, -0.5f);
    }
    
    public void render(final Entity entity, final float f, final float f1, final float f2, final float f3, final float f4, final float f5) {
        for (int i = 0; i < 8; ++i) {
            this.MortarWarheadModel[i].render(f5);
        }
    }
