...
public class ModelDartShield extends ModelGun
{
    ...
    private void initgunModel_1() {
        ...
        this.gunModel[0].addBox(0.0f, 0.0f, 0.0f, 1, 6, 14, 0.0f);
        this.gunModel[0].setRotationPoint(3.0f, 0.0f, 2.0f);
        ...
        this.gunModel[1].setRotationPoint(3.0f, -4.0f, 2.0f);
        ...
        this.gunModel[2].setRotationPoint(3.0f, -14.0f, 2.0f);
        ...
        this.gunModel[3].setRotationPoint(3.0f, -4.0f, 3.0f);
        ...
        this.gunModel[4].setRotationPoint(3.0f, -4.0f, 5.0f);
        ...
        this.gunModel[5].setRotationPoint(3.0f, -21.0f, 3.0f);
        ...
        this.gunModel[6].setRotationPoint(3.0f, -25.0f, 5.0f);
        ...
        this.gunModel[7].setRotationPoint(3.3f, 1.0f, 7.0f);
        ...
        this.gunModel[8].setRotationPoint(3.3f, 3.0f, 7.0f);
        ...
        this.gunModel[9].setRotationPoint(4.3f, 2.5f, 7.5f);
        ...
        this.gunModel[10].setRotationPoint(4.3f, 2.51f, 7.5f);
        ...
        this.gunModel[11].setRotationPoint(4.3f, 4.51f, 7.5f);
        ...
        this.gunModel[12].setRotationPoint(3.5f, -7.5f, 2.0f);
        this.gunModel[13].addBox(0.0f, 0.0f, 0.0f, 1, 1, 13, 0.0f);
        this.gunModel[13].setRotationPoint(2.5f, 3.0f, 2.5f);
        ...
        this.gunModel[14].setRotationPoint(2.5f, 4.0f, 4.0f);
        ...
        this.gunModel[15].setRotationPoint(2.5f, -1.0f, 4.0f);
        ...
        this.gunModel[16].setRotationPoint(2.5f, 4.0f, 4.0f);
        ...
        this.gunModel[17].setRotationPoint(2.5f, 5.0f, 4.0f);
        ...
        this.gunModel[18].setRotationPoint(2.5f, 4.0f, 4.0f);
        ...
        this.gunModel[19].setRotationPoint(2.5f, 4.0f, 4.0f);
        ...
        this.gunModel[20].setRotationPoint(2.5f, 4.0f, 5.5f);
        ...
        this.gunModel[21].setRotationPoint(2.5f, -1.0f, 5.5f);
        ...
        this.gunModel[22].setRotationPoint(2.5f, 5.0f, 5.5f);
        ...
        this.gunModel[23].setRotationPoint(2.5f, 4.0f, 5.5f);
        ...
        this.gunModel[24].setRotationPoint(2.5f, 4.0f, 5.5f);
        ...
        this.gunModel[25].setRotationPoint(2.5f, 4.0f, 5.5f);
        ...
        this.gunModel[26].setRotationPoint(2.5f, 4.0f, 7.0f);
        ...
        this.gunModel[27].setRotationPoint(2.5f, -1.0f, 7.0f);
        ...
        this.gunModel[28].setRotationPoint(2.5f, 5.0f, 7.0f);
        ...
        this.gunModel[29].setRotationPoint(2.5f, 4.0f, 7.0f);
        ...
        this.gunModel[30].setRotationPoint(2.5f, 5.0f, 7.0f);
        ...
        this.gunModel[31].setRotationPoint(2.5f, 4.0f, 7.0f);
        this.gunModel[32].addBox(0.0f, 0.0f, 0.0f, 1, 1, 5, 0.0f);
        this.gunModel[32].setRotationPoint(2.2f, 3.0f, 3.0f);
        this.gunModel[33].addBox(0.0f, 0.0f, 0.0f, 1, 1, 4, 0.0f);
        this.gunModel[33].setRotationPoint(2.2f, 9.5f, 3.5f);
    }
    ...
    private void initammoModel_1() {
        ...
        this.ammoModel[0].setRotationPoint(1.0f, -2.0f, 0.0f);
        this.ammoModel[0].rotateAngleZ = 1.5707964f;
        ...
        this.ammoModel[1].setRotationPoint(1.0f, -2.0f, 0.0f);
        this.ammoModel[1].rotateAngleZ = 1.5707964f;
        ...
        this.ammoModel[2].setRotationPoint(1.0f, -2.0f, 0.0f);
        this.ammoModel[2].rotateAngleZ = 1.5707964f;
        ...
        this.ammoModel[3].setRotationPoint(1.0f, -2.0f, 0.0f);
        this.ammoModel[3].rotateAngleZ = 1.5707964f;
        ...
        this.ammoModel[4].setRotationPoint(1.0f, -2.0f, 0.0f);
        this.ammoModel[4].rotateAngleZ = 1.5707964f;
        ...
        this.ammoModel[5].setRotationPoint(1.0f, -2.0f, 0.0f);
        this.ammoModel[5].rotateAngleZ = 1.5707964f;
    }
}
