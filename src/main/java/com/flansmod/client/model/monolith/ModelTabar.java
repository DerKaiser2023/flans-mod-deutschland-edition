...
public class ModelTabar extends ModelGun
{
    ...
    public ModelTabar() {
        ...
        this.gunModel[0].setRotationPoint(1.0f, -12.0f, 0.0f);
        ...
        this.gunModel[1].setRotationPoint(1.0f, -11.5f, 0.0f);
        ...
        this.gunModel[2].setRotationPoint(2.2f, -11.5f, 0.0f);
        ...
        this.gunModel[3].setRotationPoint(3.2f, -11.0f, 0.0f);
        ...
        this.gunModel[4].setRotationPoint(4.2f, -11.5f, 0.0f);
        ...
        this.gunModel[5].setRotationPoint(5.2f, -11.5f, 0.0f);
        ...
        this.gunModel[6].setRotationPoint(1.0f, -13.0f, 0.0f);
        ...
        this.gunModel[7].setRotationPoint(1.0f, -18.0f, 0.0f);
        ...
        this.gunModel[8].setRotationPoint(5.2f, -10.51f, 0.0f);
        ...
        this.gunModel[9].setRotationPoint(-1.3f, -11.5f, 0.0f);
