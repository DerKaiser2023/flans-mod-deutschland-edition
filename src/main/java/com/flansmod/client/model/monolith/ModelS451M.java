...
public class ModelS451M extends ModelPlane
{
    ...
    private void initleftWingPos1Model_1() {
        ...
        this.leftWingPos1Model[0].setRotationPoint(-21.5f, -10.5f, -26.0f);
        ...
        this.leftWingPos1Model[1].setRotationPoint(-19.5f, -12.0f, -26.0f);
    }
    ...
    private void initleftWingPos2Model_1() {
        ...
        this.leftWingPos2Model[0].setRotationPoint(-21.5f, -13.5f, -28.0f);
        this.leftWingPos2Model[0].rotateAngleX = -1.9198622f;
        ...
        this.leftWingPos2Model[1].setRotationPoint(-19.5f, -13.5f, -28.0f);
        this.leftWingPos2Model[1].rotateAngleX = -1.9198622f;
    }
    ...
    private void initrightWingPos1Model_1() {
        ...
        this.rightWingPos1Model[0].setRotationPoint(-21.5f, -10.5f, 26.0f);
        ...
        this.rightWingPos1Model[1].setRotationPoint(-19.5f, -12.0f, 26.0f);
        ...
        this.rightWingPos1Model[2].setRotationPoint(-21.5f, -13.5f, 28.0f);
        this.rightWingPos1Model[2].rotateAngleX = 1.9198622f;
        ...
        this.rightWingPos1Model[3].setRotationPoint(-19.5f, -13.5f, 28.0f);
        this.rightWingPos1Model[3].rotateAngleX = 1.9198622f;
    }
}
