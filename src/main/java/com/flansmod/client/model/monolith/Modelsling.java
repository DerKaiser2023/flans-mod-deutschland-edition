...
public class Modelsling extends ModelGun
{
    ...
    public Modelsling() {
        ...
        this.gunModel[0].setRotationPoint(0.0f, -2.0f, -2.5f);
        ...
        this.gunModel[1].setRotationPoint(3.0f, -2.0f, -2.5f);
        ...
        this.gunModel[2].setRotationPoint(-2.0f, -2.0f, -2.5f);
        ...
        this.gunModel[3].setRotationPoint(-2.0f, -2.0f, 14.5f);
        ...
        this.gunModel[4].setRotationPoint(0.0f, -2.0f, 14.5f);
        ...
        this.gunModel[5].setRotationPoint(3.0f, -2.0f, 14.5f);
        ...
        this.gunModel[6].setRotationPoint(0.0f, 40.0f, 8.5f);
        ...
        this.gunModel[7].setRotationPoint(2.0f, 42.0f, 4.5f);
        ...
        this.gunModel[8].setRotationPoint(-2.0f, 42.0f, 4.5f);
        ...
        this.gunModel[9].setRotationPoint(1.0f, 42.0f, 4.5f);
        ...
        this.gunModel[10].setRotationPoint(-2.0f, 41.0f, 2.5f);
        ...
        this.gunModel[11].setRotationPoint(3.0f, 41.0f, 2.5f);
        ...
        this.gunModel[12].setRotationPoint(-2.0f, 41.0f, 8.5f);
        ...
        this.gunModel[13].setRotationPoint(3.0f, 41.0f, 8.5f);
        ...
        this.gunModel[14].setRotationPoint(0.0f, 41.0f, -2.5f);
        ...
        this.ammoModel[0].setRotationPoint(1.0f, 41.0f, 5.5f);
